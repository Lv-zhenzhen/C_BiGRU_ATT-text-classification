...
cnn_data = np.loadtxt('./data/char_data/char_dim/char_cnn_embeddings_20_30_dim8.txt')
...
x_shuffled = concat_cnn_BiGRU_ATT[shuffle_indices]  # 将文本和标签打乱
...
with open('./result/concat_cnn_20_30_dim8_BIGRU_600_dim8.txt', 'a', encoding="utf-8") as f:
    f.write(str(result) + "\n")
