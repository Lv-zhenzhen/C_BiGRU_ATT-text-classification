...
filedir = '../data/word_data/word_BiGRU_attention_embeddings/'  # 获取目标文件夹路径
...
# cross_validation.cross_val_score
    ...
    f = open('../result/svm_word_BiGRU_attention/word_BiGRU_attention_embeddings.txt', 'a', encoding="utf-8")
